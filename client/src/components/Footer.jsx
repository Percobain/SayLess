...
export default function Footer() {
  return (
    <footer className="bg-neo-black text-neo-white border-t-[3px] border-neo-black">
      <div className="container mx-auto px-4 py-8">
        <div className="grid md:grid-cols-3 gap-8">
          {/* Brand */}
          <div>
            <div className="flex items-center gap-2 mb-4">
              <div className="bg-neo-orange border-[2px] border-neo-white p-1.5">
        ...
        <div className="neo-divider bg-gray-700 my-8"></div>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4">
            <a href="#" className="text-gray-400 hover:text-neo-orange transition-colors">
