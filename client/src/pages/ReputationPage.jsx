...
const reputationTiers = [
  { name: 'Newcomer', min: 0, max: 25, color: 'bg-gray-400' },
  { name: 'Regular', min: 26, max: 50, color: 'bg-blue-400' },
  { name: 'Trusted', min: 51, max: 75, color: 'bg-neo-purple' },
  { name: 'Expert', min: 76, max: 90, color: 'bg-neo-green' },
  { name: 'Guardian', min: 91, max: 100, color: 'bg-neo-orange' },
];
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 max-w-xl mx-auto">
            Your pseudonymous identity on SAYLESS. Build reputation through verified reports.
          </p>
        </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <NeoCard variant="black" className="p-6 mb-8">
            <div className="flex flex-col md:flex-row items-center justify-between gap-4">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="text-xs text-gray-400 uppercase">Anonymous Identity</p>
          ...
          <NeoCard className="p-6 mb-8">
            <div className="flex items-center justify-between mb-4">
              <h3 className="font-heading font-bold text-lg">Reputation Score</h3>
              <button 
            ...
            {showExplainer && (
              <NeoCard className="mt-4 p-4 bg-gray-50">
                <h4 className="font-bold mb-2">How Reputation Works</h4>
                <ul className="text-sm space-y-1 text-gray-600">
                  <li>• Verified reports: <span className="text-green-600">+5 points</span></li>
                  <li>• Rejected reports: <span className="text-red-600">-3 points</span></li>
                  <li>• Correct jury votes: <span className="text-green-600">+2 points</span></li>
                  <li>• Wrong jury votes: <span className="text-red-600">-1 point</span></li>
                  <li>• Higher reputation = Higher vote weight in jury</li>
                </ul>
              </NeoCard>
            )}
          </NeoCard>
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            ...
            <NeoCard className="p-6">
              <h3 className="font-heading font-bold text-lg mb-4">Report Statistics</h3>
            ...
            {/* Jury Stats */}
            <NeoCard className="p-6">
              <h3 className="font-heading font-bold text-lg mb-4">Jury Participation</h3>
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            <NeoCard variant="green" className="p-6">
              <div className="flex items-center gap-3 mb-2">
                ...
                <span className="font-heading font-bold">Rewards Earned</span>
              </div>
            ...
            <NeoCard className="p-6 bg-red-100">
              <div className="flex items-center gap-3 mb-2">
                ...
                <span className="font-heading font-bold text-red-600">Penalties</span>
              </div>
